    ...
    <div className="max-w-4xl mx-auto space-y-12 text-white">
      ...
      <div className={sectionStyle}>
        <label className={labelStyle}>
          <Settings className="w-5 h-5 text-emerald-400" /> Vites Tipi
        </label>
        <div className="grid grid-cols-3 gap-4">
          {vitesOptions.map((option) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg transition-all duration-200 ${
                  formData.vites === option.value
                    ? "bg-indigo-500"
      ...
      <div className={sectionStyle}>
        <label className={labelStyle}>
          <Fuel className="w-5 h-5 text-indigo-400" /> Yakıt Tipi
        </label>
      ...
      <div className={sectionStyle}>
        <label className={labelStyle}>
          <Car className="w-5 h-5 text-pink-400" /> Kasa Tipi
        </label>
        <div className="flex flex-wrap gap-3">
      ...
      <div className={sectionStyle}>
        <label className={labelStyle}>
          <Palette className="w-5 h-5 text-purple-400" /> Renk
        </label>
        <div className="flex flex-wrap gap-3">
